...
def calc_pedagio(primeiro_emprego, sexo):
    ...
    total_pedagio = abs((fim_conta - primeiro_emprego).days)+1 #total de contribuição até 07/03/2020
    falta_pedagio = ''
    ...
    if sexo == 'feminino':
        if total_pedagio >= 10950:
            ...
            return print('Completará o pedágio em: ' + datetime.strftime(data_pedagio, '%d/%m/%Y'))
    elif sexo == 'masculino':
